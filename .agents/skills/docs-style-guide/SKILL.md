...
description: HashiCorp education and documentation style guide. Use when writing docs, tutorials, WAF, or certification content to follow style standards.
---

# Education style guide

**This skill's source docs:** https://github.com/hashicorp/web-unified-docs/blob/main/docs/style-guide
